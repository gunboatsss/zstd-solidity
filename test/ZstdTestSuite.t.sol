...
contract ZstdTestSuite is Test {
    ...
    function test_raw_fox() public {
        bytes memory c = hex"28b52ffd005861010054686520717569636b2062726f776e20666f78206a756d7073206f76657220746865206c617a7920646f672e";
    ...
    function test_raw_binary() public {
        bytes memory c = hex"28b52ffd0058010200000102030405060708090a0b0c0d0e0f101112131415161718191a1b1c1d1e1f202122232425262728292a2b2c2d2e2f303132333435363738393a3b3c3d3e3f";
        bytes memory expected = hex"000102030405060708090a0b0c0d0e0f101112131415161718191a1b1c1d1e1f202122232425262728292a2b2c2d2e2f303132333435363738393a3b3c3d3e3f";
    ...
    function test_repetitive_45x20() public {
        bytes memory c = hex"28b52ffd0058b50100d40254686520717569636b2062726f776e20666f78206a756d7073206f76657220746865206c617a7920646f672e200100a50a2b5506";
        bytes memory r = ZstdDecompress.decompress(c);
        assertEq(r.length, 900);
    }
    function test_fuzz_counterexample_86() public {
        bytes memory c = hex"28b52ffd20560d0200a403000029d4c02a30c59d449bf1e6d0869c40dca3e4799100cf1ca65261c476654bae4fc905d241f77180b212ee3d5cfc2429057b859d3c8328d1ea01000cc002";
        bytes memory r = ZstdDecompress.decompress(c);
